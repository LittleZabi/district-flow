    ...
    <div>
      ...
      <div className="page-size">
        <div className="fade-in flex home-login-outer">
          <div className="flex home-x2" style={user ? {alignItems: 'flex-start'} : {}}>
        ...
        <div className="fade-in home-x3">
          <div className="sup0333">
            <p>
              ...
              goodbye to long queues and paperwork hassles, as our user-friendly
              interface streamlines the entire process. Unlock a world of
              efficiency and transparency as you leverage the power of digital
              technology. Track the progress of your applications in real-time,
              receive timely updates, and ensure that your voice is heard. Our
              platform is built to empower you, providing a seamless channel to
              connect with the District Officer and access essential services.
              Join a community of engaged citizens and contribute to the growth
              and development of your district. Together, we can foster
              effective governance, enhance communication, and build a brighter
              future. Embrace the ease and accessibility of our online platform,
              and let your applications and letters make an impact today!
            </p>
            <iframe
